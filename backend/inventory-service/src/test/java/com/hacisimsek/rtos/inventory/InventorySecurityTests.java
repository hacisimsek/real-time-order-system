package com.hacisimsek.rtos.inventory;
...
class InventorySecurityTests {
    ...
    @MockBean
    com.hacisimsek.rtos.inventory.messaging.OrderEventsListener orderEventsListener;

    @MockBean
    com.hacisimsek.rtos.inventory.service.IdempotencyService idempotencyService;

    @MockBean
    com.hacisimsek.rtos.inventory.repository.MessageLogRepository messageLogRepository;
