...
import com.hacisimsek.reporting.dto.ReportRefreshRequest;
...
public class ReportController {
    ...
    @PreAuthorize("""
            hasAnyAuthority(
                T(com.hacisimsek.security.Roles).REPORTING_READ,
                T(com.hacisimsek.security.Roles).REPORTING_EXPORT)
            """)
    ...
    @PreAuthorize("hasAuthority(T(com.hacisimsek.security.Roles).REPORTING_EXPORT)")
    ...
    @GetMapping("/totals")
    @PreAuthorize("hasAnyAuthority(T(com.hacisimsek.security.Roles).REPORTING_READ, T(com.hacisimsek.security.Roles).REPORTING_EXPORT)")
